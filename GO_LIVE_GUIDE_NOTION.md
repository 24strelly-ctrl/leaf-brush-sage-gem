...
**⚠️ Important:** This does NOT work well on Vercel because Vercel doesn't keep files between requests.
...
**⚠️ Important:** Data disappears when the server restarts. Not for production.
...
**⚠️ Warning:** SQLite on Vercel is not recommended. Your data might disappear. Consider using Supabase or Neon instead.
