/**
 * Standalone API Server for Workspace Integration
 * Runs on port 3001 to avoid conflicts with main dev server
 */
...
// Mock data for testing (in production, this would connect to the actual data sources)
const MOCK_DATA = {
  contentCalendar: {
